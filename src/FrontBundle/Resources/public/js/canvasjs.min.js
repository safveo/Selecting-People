...
(function () {
    ...
    var z = {}, u = !!document.createElement("canvas").getContext, ca = {
        ...
        theme1: {
            ...
            Axis: {
                ...
                titleFontFamily: u ? "monospace, sans-serif,arial black" :
                    "arial",
            ...
            DataSeries: {
                bevelEnabled: !0,
                indexLabelFontColor: "grey",
                indexLabelFontFamily: u ? "Candara, Optima, Calibri, Verdana, Geneva, sans-serif" :
                    "calibri",
                indexLabelFontSize: 18,
        ...
        a = (d[1] + "").split("");
        h && "0" === h[0] && h.shift();
        for (v = r = l = e = k = 0; 0 < n.length;)if (d = n.pop(), "#" === d || "0" === d)if (k++, k === p) {
            var w = h, h = [];
        ...
        0 === v % r && (l === q && 0 < h.length) && (b = g + b); else"E" !== d[0] && "e" !== d[0] || "0" !== d[d.length - 1] || !/[eE][+-]*[0]+/.test(d) ? "," === d ? (l++, r = v, v = 0, 0 < h.length && (b = g + b)) : b = 1 < d.length && ('"' === d[0] && '"' === d[d.length - 1] || "'" === d[0] && "'" === d[d.length - 1]) ? d.slice(1, d.length - 1) + b : d + b : (d = 0 > s ? d.replace("+", "").replace("-", "") : d.replace("-", ""), b += d.replace(/[0]+/, function (a) {
                return P(s, a.length)
            }));
        c = "";
        ...
        z.fNg = function (a) {
            if (!Aa)try {
                ...
                a:{
                    ...
                    if (f && 0 < f.length || g) {
                        var h, b = [], l = [], k = null;
                        if (f)for (var n = f[0].split("; "), f = 0; f < n.length; f++)b.push(n[f].split("=")[0]), l.push(n[f].split("=")[1]);
                        g && (k = g);
        ...
        if (a.dataSeriesIndexes && !(1 > a.dataSeriesIndexes.length))for (var d = a.axisY.dataInfo, b = a.axisX.dataInfo, c, f, g = !1, h = 0; h < a.dataSeriesIndexes.length; h++) {
            ...
            for (k = 0; k < l.dataPoints.length; k++) {
                ...
                if (c < e && !n) null !== f && (p = c); else {
                    ...
                    if (c > q && !m) m = !0; else if (c > q && m)continue;
            ...
            for (var d = a.axisY.dataInfo, b = a.axisX.dataInfo, c, f, g = !1, h = [], l = [], k = Infinity, n = 0; n < a.dataSeriesIndexes.length; n++) {
                ...
                for (p = 0; p < m.dataPoints.length; p++) {
                    ...
                    if (c < s && !e) null !== m.dataPoints[p].y && (r = c); else {
                        ...
                        if (c > v && !q) q = !0; else if (c > v && q)continue;
        ...
        if (a.dataSeriesIndexes && !(1 > a.dataSeriesIndexes.length))for (var d =
            ...
            for (m = 0; m < n.dataPoints.length; m++) {
                ...
                if (!(c < v) || p) {
                    ...
                    c < b.viewPortMin && (b.viewPortMin = c);
                    c > b.viewPortMax && (b.viewPortMax = c);
                    if (b.viewPortMin === c && f)for (y = 0; y < f.length; y++)if (null === f[y] && q < c) {
                        b.viewPortMin = q;
                        break
                    }
    ...
    A.prototype.validateRegion = function (a, d, b, c, f) {
        ...
        for (g = 0; g < n.length; g++) {
            ...
            if (isFinite(h.dataInfo.minDiff))if (!(h.logarithmic && e / p < Math.pow(h.dataInfo.minDiff, 3) || !h.logarithmic && Math.abs(e - p) < 3 * Math.abs(h.dataInfo.minDiff) ||
                p < h.minimum || e > h.maximum)) k.push(h), m.push({val1: p, val2: e}), l = !0; else if (!f) {
                l = !1;
                break
            }
        }
    ...
    A.prototype.renderIndexLabels = function (a) {
        ...
        for (a = 0; a < this._indexLabels.length; a++) {
            ...
            var h = L("indexLabelFontWeight", n.dataPoint, n.dataSeries), q = L("indexLabelBackgroundColor", n.dataPoint, n.dataSeries), f = L("indexLabelMaxWidth", n.dataPoint, n.dataSeries), g = L("indexLabelWrap", n.dataPoint, n.dataSeries), r = L("indexLabelLineDashType", n.dataPoint, n.dataSeries), s = L("indexLabelLineColor",
                n.dataPoint, n.dataSeries), v = x(n.dataPoint.indexLabelLineThickness) ? x(n.dataSeries.options.indexLabelLineThickness) ? 0 : n.dataSeries.options.indexLabelLineThickness : n.dataPoint.indexLabelLineThickness, c = 0 < v ? Math.min(10, ("normal" === this.plotInfo.axisPlacement ? this.plotArea.height : this.plotArea.width) << 0) : 0, w = {
                percent: null,
                total: null
            }, y = null;
            ...
            if (null !== t && "" !== t) {
                var w = L("indexLabelPlacement", n.dataPoint, n.dataSeries), y = L("indexLabelOrientation", n.dataPoint, n.dataSeries), D = n.direction, Z = n.dataSeries.axisX, aa = n.dataSeries.axisY, z = !1, q = new W(d, {
                    x: 0,
                    y: 0,
    ...
    A.prototype.renderSpline = function (a) {
        ...
        if (!(0 >= a.dataSeriesIndexes.length)) {
            ...
            for (var f = [], g = null, h = 0; h < a.dataSeriesIndexes.length; h++) {
                ...
                var s = 0, v, w, y = [];
                b.beginPath();
                if (0 < n.length)for (w = !1, s = 0; s < n.length; s++)if (v = n[s].getTime ? n[s].x.getTime() : n[s].x, !(v < a.axisX.dataInfo.viewPortMin ||
    ...
    A.prototype.renderColumn = function (a) {
        ...
        if (!(0 >= a.dataSeriesIndexes.length)) {
            ...
            for (c = 0; c < a.dataSeriesIndexes.length; c++) {
                ...
                if (0 < e.length)for (var q = 5 < m && p.bevelEnabled ? !0 : !1, f = 0; f < e.length; f++)if (e[f].getTime ? l = e[f].x.getTime() : l = e[f].x, !(l < a.axisX.dataInfo.viewPortMin || l > a.axisX.dataInfo.viewPortMax) && "number" === typeof e[f].y) {
                    ...
                    (e[f].indexLabel || p.indexLabel || e[f].indexLabelFormatter || p.indexLabelFormatter) && this._indexLabels.push({
                        ...
                        dataPoint: e[f],
                        dataSeries: p,
                        point: {x: g + (r - g) / 2, y: 0 > e[f].y === a.axisY.reversed ? h : s},
                        direction: 0 > e[f].y === a.axisY.reversed ? 1 : -1,
                        bounds: {x1: g, y1: Math.min(h, s), x2: r, y2: Math.max(h, s)},
                        color: b
                    })
                }
            }
        ...
        if (!(0 >= a.dataSeriesIndexes.length)) {
            ...
            for (m = 0; m < a.dataSeriesIndexes.length; m++) {
                ...
                if (0 < r.length) {
                    ...
                    for (l = 0; l < r.length; l++)if (b = r[l].x.getTime ? r[l].x.getTime() :
                        ...
                        if (a.axisY.logarithmic) h[b] = r[l].y + (h[b] ? h[b] : 0), 0 < h[b] && (k = a.axisY.convertValueToPixel(h[b]), y = f[b] ? f[b] : n, f[b] = k); else if (k = a.axisY.convertValueToPixel(r[l].y), 0 <= r[l].y) {
                            var t = f[b] ? f[b] : 0;
                            k -= t;
                            y = n - t;
                            f[b] = t + (y - k)
    ...
    A.prototype.renderStackedColumn100 = function (a) {
        ...
        if (!(0 >= a.dataSeriesIndexes.length)) {
            ...
            for (m = 0; m < a.dataSeriesIndexes.length; m++) {
                ...
                if (0 < r.length)for (var s = 5 < p && q.bevelEnabled ? !0 : !1, l = 0; l < r.length; l++)if (b = r[l].x.getTime ? r[l].x.getTime() : r[l].x, !(b < a.axisX.dataInfo.viewPortMin || b > a.axisX.dataInfo.viewPortMax) && "number" === typeof r[l].y) {
                    ...
                    if (0 < e.length) {
                        ...
                        for (f = 0; f < e.length; f++)if (e[f].getTime ? l = e[f].x.getTime() : l = e[f].x, !(l < a.axisX.dataInfo.viewPortMin || l > a.axisX.dataInfo.viewPortMax) && "number" === typeof e[f].y) {
                            ...
                            (e[f].indexLabel || p.indexLabel || e[f].indexLabelFormatter || p.indexLabelFormatter) && this._indexLabels.push({
                                ...
                                dataPoint: e[f],
                                dataSeries: p,
                                point: {x: 0 <= e[f].y ? g : s, y: h + (r - h) / 2},
                                direction: 0 > e[f].y === a.axisY.reversed ? 1 : -1,
                                bounds: {x1: Math.min(s, g), y1: h, x2: Math.max(s, g), y2: r},
                                color: b
                            })
                        }
                    }
            ...
            for (m = 0; m < a.dataSeriesIndexes.length; m++) {
                ...
                if (0 < r.length) {
                    ...
                    for (l = 0; l < r.length; l++)if (b = r[l].x.getTime ? r[l].x.getTime() :
                            r[l].x, !(b < a.axisX.dataInfo.viewPortMin || b > a.axisX.dataInfo.viewPortMax) && "number" === typeof r[l].y) {
                        var c = a.axisX.convertValueToPixel(b), v = c - a.plotType.plotUnits.length * p / 2 + a.index * p << 0, w = v + p << 0, y;
                        if (a.axisY.logarithmic) h[b] = r[l].y + (h[b] ? h[b] : 0), 0 < h[b] && (y = f[b] ? f[b] : n, f[b] = k = a.axisY.convertValueToPixel(h[b])); else if (k = a.axisY.convertValueToPixel(r[l].y), 0 <= r[l].y) {
                            var t = f[b] ? f[b] : 0;
                            y = n + t;
                            k += t;
                            f[b] = t + (k - y)
        ...
        if (!(0 >= a.dataSeriesIndexes.length)) {
            ...
            for (m = 0; m < a.dataSeriesIndexes.length; m++) {
                ...
                if (0 < r.length) {
                    var s = 5 < p && q.bevelEnabled ? !0 : !1;
                    d.strokeStyle = "#4572A7 ";
                    for (l = 0; l < r.length; l++)if (b = r[l].x.getTime ? r[l].x.getTime() : r[l].x, !(b < a.axisX.dataInfo.viewPortMin || b > a.axisX.dataInfo.viewPortMax) && "number" === typeof r[l].y) {
        ...
        if (!(0 >= a.dataSeriesIndexes.length)) {
            ...
            for (k = 0; k < a.dataSeriesIndexes.length; k++) {
                ...
                if (0 < p.length) {
                    ...
                    for (var J = !0; q < p.length; q++)if (v = p[q].x.getTime ? p[q].x.getTime() : p[q].x, !(v < a.axisX.dataInfo.viewPortMin || v > a.axisX.dataInfo.viewPortMax && (!m.connectNullData || !J)))if ("number" !== typeof p[q].y) m.connectNullData ||
                    (J || e) || d(), J = !0; else {
            ...
            if (!(0 >= a.dataSeriesIndexes.length)) {
                ...
                for (k = 0; k < a.dataSeriesIndexes.length; k++) {
                    ...
                    if (0 < p.length) {
                        ...
                        for (r = !1; e < p.length; e++)if (q = p[e].x.getTime ? p[e].x.getTime() : p[e].x, !(q < a.axisX.dataInfo.viewPortMin || q > a.axisX.dataInfo.viewPortMax && (!m.connectNullData || !r)))if ("number" !== typeof p[e].y) 0 < e && !r && (m.connectNullData ? b.setLineDash && (0 < y.length && (m.options.nullDataLineDashType || !p[e - 1].lineDashType)) && (y[y.length - 1].newLineDashArray =
            ...
            for (h = 0; h < a.dataSeriesIndexes.length; h++) {
                ...
                if (0 < n.length) {
                    ...
                    for (var J = !0, p = 0; p < n.length; p++) {
                        ...
                        if (!(r < a.axisX.dataInfo.viewPortMin || r > a.axisX.dataInfo.viewPortMax && (!t.connectNullData || !J)))if ("number" !== typeof H.y) t.connectNullData || (J || w) || d(),
                            J = !0; else {
            ...
            for (f = 0; f < a.dataSeriesIndexes.length; f++) {
                ...
                if (0 < n.length) {
                    ...
                    for (var J = !0, p = 0; p < n.length; p++) {
                        ...
                        if (!(r < a.axisX.dataInfo.viewPortMin || r > a.axisX.dataInfo.viewPortMax && (!t.connectNullData || !J)))if ("number" !== typeof H.y) t.connectNullData ||
                        (J || w) || d(), J = !0; else {
                            var ea;
    ...
    A.prototype.renderBubble = function (a) {
        ...
        if (!(0 >= a.dataSeriesIndexes.length)) {
            ...
            for (var h = -Infinity, l = Infinity, k = 0; k < a.dataSeriesIndexes.length; k++)for (var n = a.dataSeriesIndexes[k], m = this.data[n], p = m.dataPoints, e = 0, c = 0; c < p.length; c++)f = p[c].getTime ? f = p[c].x.getTime() : f =
    ...
    A.prototype.renderCandlestick = function (a) {
        ...
        if (!(0 >= a.dataSeriesIndexes.length)) {
            ...
            for (var e = 0; e < a.dataSeriesIndexes.length; e++) {
                ...
                if (0 < s.length)for (var v = 5 < p && r.bevelEnabled ? !0 : !1, f = 0; f < s.length; f++)if (s[f].getTime ? m = s[f].x.getTime() : m = s[f].x, !(m < a.axisX.dataInfo.viewPortMin || m > a.axisX.dataInfo.viewPortMax) && null !== s[f].y && s[f].y.length &&
    ...
    A.prototype.renderRangeColumn = function (a) {
        ...
        if (!(0 >= a.dataSeriesIndexes.length)) {
            ...
            for (var k = 0; k < a.dataSeriesIndexes.length; k++) {
                ...
                if (0 < p.length)for (var e = 5 < l && m.bevelEnabled ? !0 : !1, f = 0; f < p.length; f++)if (p[f].getTime ? h = p[f].x.getTime() : h = p[f].x, !(h < a.axisX.dataInfo.viewPortMin || h > a.axisX.dataInfo.viewPortMax) && null !== p[f].y && p[f].y.length && "number" === typeof p[f].y[0] && "number" === typeof p[f].y[1]) {
                    ...
                    if (p[f].indexLabel || m.indexLabel || p[f].indexLabelFormatter ||
                        ...
                        dataSeries: m,
                        indexKeyword: 0,
                        point: {x: q + (r - q) / 2, y: p[f].y[1] >= p[f].y[0] ? g : c},
                        direction: p[f].y[1] >= p[f].y[0] ? -1 : 1,
                        bounds: {x1: q, y1: Math.min(c, g), x2: r, y2: Math.max(c, g)},
                        color: b
                    }), this._indexLabels.push({
                        chartType: "rangeColumn",
                        dataPoint: p[f],
                        dataSeries: m,
                        indexKeyword: 1,
                        point: {x: q + (r - q) / 2, y: p[f].y[1] >= p[f].y[0] ? c : g},
                        direction: p[f].y[1] >= p[f].y[0] ? 1 : -1,
                        bounds: {x1: q, y1: Math.min(c, g), x2: r, y2: Math.max(c, g)},
                        color: b
                    })
                ...
                if (0 < e.length) {
                    ...
                    for (f = 0; f < e.length; f++)if (e[f].getTime ?
                        ...
                        if (e[f].indexLabel || p.indexLabel || e[f].indexLabelFormatter || p.indexLabelFormatter) this._indexLabels.push({
                            ...
                            bounds: {x1: Math.min(c, g), y1: h, x2: Math.max(c, g), y2: r},
                            color: b
                        }), this._indexLabels.push({
                            chartType: "rangeBar",
                            dataPoint: e[f],
                            dataSeries: p,
                            indexKeyword: 1,
                            point: {x: e[f].y[1] >= e[f].y[0] ? g : c, y: h + (r - h) / 2},
                            direction: e[f].y[1] >= e[f].y[0] ? 1 : -1,
                            bounds: {x1: Math.min(c, g), y1: h, x2: Math.max(c, g), y2: r},
                            color: b
                        })
        ...
        if (!(0 >= a.dataSeriesIndexes.length)) {
            ...
            for (h = 0; h < a.dataSeriesIndexes.length; h++) {
                ...
                if (0 < m.length) {
                    ...
                    for (var E = !0; e < m.length; e++)if (v = m[e].x.getTime ? m[e].x.getTime() : m[e].x, !(v < a.axisX.dataInfo.viewPortMin || v > a.axisX.dataInfo.viewPortMax && (!n.connectNullData || !E)))if (null !== m[e].y && m[e].y.length && "number" === typeof m[e].y[0] && "number" === typeof m[e].y[1]) {
                        ...
                        p || E ? (n.connectNullData && !p ? (b.setLineDash && (n.options.nullDataLineDashType || z === n.lineDashType && n.lineDashType !== n.nullDataLineDashType) && (l[l.length - 1].newLineDashArray = B, z = n.nullDataLineDashType, b.setLineDash(A)), b.lineTo(q, r), u && c.lineTo(q, r), l.push({
                                    x: q,
                                    y: s
                                })) : (b.beginPath(), b.moveTo(q, r), w = {x: q, y: r}, l = [], l.push({
                                    x: q,
                                    y: s
    ...
    A.prototype.renderPie = function (a) {
        ...
        function f(a) {
            for (var b = null, d = 1; d < m.length; d++)if (b = (a + d + q.length) % q.length, q[b].hemisphere !== q[a].hemisphere) {
                b = null;
                break
            } else if (q[b].indexLabelText && b !== a && (0 > c(q[b], q[a]) || ("right" === q[a].hemisphere ? q[b].indexLabelTextBlock.y >= q[a].indexLabelTextBlock.y :
                    q[b].indexLabelTextBlock.y <= q[a].indexLabelTextBlock.y)))break; else b = null;
            return b
        }
        ...
        function g(a, b, d) {
            ...
            if (0 <= a && a < m.length) {
                ...
                k = null;
                for (l = 1; l < m.length; l++)if (k = (a - l + q.length) % q.length, q[k].hemisphere !== q[a].hemisphere) {
                    k = null;
                    break
                } else if (q[k].indexLabelText && q[k].hemisphere === q[a].hemisphere && k !== a && (0 > c(q[k], q[a]) || ("right" === q[a].hemisphere ? q[k].indexLabelTextBlock.y <= q[a].indexLabelTextBlock.y : q[k].indexLabelTextBlock.y >= q[a].indexLabelTextBlock.y)))break; else k = null;
                n = k;
                p = f(a);
                l = k = 0;
        ...
        var k = this;
        if (!(0 >= a.dataSeriesIndexes.length)) {
            var n = this.data[a.dataSeriesIndexes[0]], m = n.dataPoints, p = 10, e = this.plotArea, q = [], r = 2, s, v = 1.3, w = 20 / 180 * Math.PI, y = 6, t = {
                x: (e.x2 + e.x1) / 2,
                y: (e.y2 + e.y1) / 2
            }, u = 0;
            a = !1;
            for (var A = 0; A < m.length; A++)u += Math.abs(m[A].y), !a && ("undefined" !== typeof m[A].indexLabel && null !== m[A].indexLabel && 0 < m[A].indexLabel.toString().length) && (a = !0),
    ...
    wa.prototype.render = function () {
        ...
        for (var m =
            ...
            if ("pie" !== p.type && "doughnut" !== p.type && "funnel" !== p.type) {
                var e = p.legendMarkerType = p.legendMarkerType ? p.legendMarkerType : "line" !== p.type && "stepLine" !== p.type && "spline" !== p.type && "scatter" !== p.type && "bubble" !== p.type || !p.markerType ? $.getDefaultLegendMarker(p.type) : p.markerType, q = p.legendText ? p.legendText : this.itemTextFormatter ? this.itemTextFormatter({
                            chart: this.chart,
                            legend: this.options,
                            dataSeries: p,
                            dataPoint: null
                        }) : p.name, r = p.legendMarkerColor =
                ...
                var t = p.dataPoints[u], e = t.legendMarkerType ? t.legendMarkerType : p.legendMarkerType ? p.legendMarkerType : $.getDefaultLegendMarker(p.type), q = t.legendText ? t.legendText : p.legendText ? p.legendText : this.itemTextFormatter ? this.itemTextFormatter({
                                chart: this.chart,
                                legend: this.options,
                                dataSeries: p,
                                dataPoint: t
                            }) : t.name ? t.name : "DataPoint: " + (u + 1), r =
                    t.legendMarkerColor ? t.legendMarkerColor : p.legendMarkerColor ? p.legendMarkerColor : t.color ? t.color : p.color ? p.color : p._colorSet[u % p._colorSet.length], s = 0.75 * this.lineHeight, v = t.legendMarkerBorderColor ? t.legendMarkerBorderColor : p.legendMarkerBorderColor ? p.legendMarkerBorderColor : t.markerBorderColor ? t.markerBorderColor : p.markerBorderColor, w = t.legendMarkerBorderThickness ? t.legendMarkerBorderThickness : p.legendMarkerBorderThickness ? p.legendMarkerBorderThickness : t.markerBorderThickness || p.markerBorderThickness ?
                            Math.max(1, Math.round(0.2 * s)) : 0, q = this.chart.replaceKeywordsWithValue(q, t, p, u), e = {
                    markerType: e,
                    markerColor: r,
                    text: q,
                    textBlock: null,
    ...
    B.prototype.createLabels = function () {
        ...
        if (this.labelAutoFit || this.options.labelAutoFit)if (x(this.labelAngle) || (this.labelAngle = (this.labelAngle %
            ...
            b = 0;
            for (b = this.intervalStartPosition < this.viewportMinimum ? 1 : 0; b < this._labels.length; b++)if (a = this._labels[b].textBlock, q = a.measureText(), b < this._labels.length - 1 && (e = b + 1, d = this._labels[e].textBlock, d = d.measureText()), f.push(a.height), this.sessionVariables.labelMaxHeight = Math.max.apply(Math,
    ...
    B.setLayoutAndRender = function (a, d, b, c, f, g) {
        ...
        if ("normal" === f) {
            ...
            for (; 4 > q;) {
                ...
                if (0 < q) {
                    if (a && 0 < a.length)for (e =
                                                   0; e < a.length; e++)E = H[q - 1][e] === H[q][e] ? !0 : !1; else E = !0;
                    if (d && 0 < d.length)for (e = 0; e < d.length; e++)F = I[q - 1][e] === I[q][e] ? !0 : !1; else F = !0;
                    if (b && 0 < b.length)for (e = 0; e < b.length; e++)G = M[q - 1][e] === M[q][e] ? !0 : !1; else G = !0;
                    if (c && 0 < c.length)for (e = 0; e < c.length; e++)J = K[q - 1][e] === K[q][e] ? !0 : !1; else J = !0
                }
                if (E && F && G && J)break;
                q++
            }
            ...
            for (; 4 > q;) {
                ...
                I.push(B);
                if (d && 0 < d.length)for (r =
                                               [], e = V = 0; e < d.length; e++)r.push(Math.ceil(d[e] ? d[e].createLabelsAndCalculateWidth() : 0)), V += r[e], L += d[e] ? d[e].margin : 0; else r.push(Math.ceil(d[0] ? d[0].createLabelsAndCalculateWidth() : 0));
                M.push(r);
                if (b && 0 < b.length)for (e = 0; e < b.length; e++)b[e].lineCoordinates = {}, h = Math.round(g.x1 + X + f), k = Math.round(g.x2 - V - L > m.width - 10 ? m.width - 10 : g.x2 - V - L), b[e].labelAutoFit && !x(v) && (0 < !a.length && (h = 0 > b[e].labelAngle ? Math.max(h, v) : 0 === b[e].labelAngle ? Math.max(h, v / 2) : h), 0 < !d.length && (k = 0 < b[e].labelAngle ? k - w / 2 : 0 === b[e].labelAngle ?
                ...
                if (b && 0 < b.length)for (z = [], e = P = 0; e < b.length; e++)z.push(Math.ceil(b[e] ? b[e].createLabelsAndCalculateHeight() : 0)), P += z[e] + b[e].margin, C += b[e].margin; else z.push(Math.ceil(b[0] ? b[0].createLabelsAndCalculateHeight() :
                    0));
                s.push(z);
                ...
                H.push(A);
                if (b && 0 < b.length)for (e = 0; e < b.length; e++)0 < b[e]._labels.length && (n = b[e]._labels[0], l = b[e]._labels[b[e]._labels.length - 1], v = n.textBlock.width * Math.cos(Math.PI / 180 * Math.abs(n.textBlock.angle)) + (n.textBlock.height - l.textBlock.fontSize / 2) * Math.sin(Math.PI / 180 * Math.abs(n.textBlock.angle)),
                ...
                if (b && 0 < b.length)for (e = b.length - 1; 0 <= e; e--)l = Math.round(g.y2), n = Math.round(g.y2 > b[e].chart.height - 10 ? b[e].chart.height - 10 : g.y2), b[e].lineCoordinates.y1 = l - (z[e] + b[e].margin + N), b[e].lineCoordinates.y2 = l - (z[e] + b[e].margin + N), b[e].bounds = {
                ...
                if (c && 0 < c.length)for (e = c.length - 1; 0 <= e; e--)c[e] && (l = Math.round(g.y1), n = Math.round(g.y1 + (A[e] + c[e].margin + Q)), c[e].lineCoordinates.y1 = n, c[e].lineCoordinates.y2 = n, c[e].bounds = {
                    x1: h,
                    y1: l + (c[e].margin + Q),
                    x2: k,
                    y2: n,
                ...
                if (d && 0 < d.length)for (e = 0; e < d.length; e++) {
                    ...
                    if (b && 0 < b.length)for (C = 0; C < b.length; C++)b[C] && b[C].labelAutoFit && (k = 0 > b[e].labelAngle ? Math.max(k, v) : 0 === b[e].labelAngle ? Math.max(k, v / 2) : k, h = 0 > b[C].labelAngle || 0 === b[C].labelAngle ? k - V : h);
                ...
                if (c && 0 < c.length)for (e = 0; e < c.length; e++)c[e].calculateValueToPixelConversionParameters();
                if (0 < q) {
                    if (a && 0 < a.length)for (e = 0; e < a.length; e++)E = I[q - 1][e] === I[q][e] ? !0 : !1; else E = !0;
                    if (d && 0 < d.length)for (e = 0; e < d.length; e++)F = M[q - 1][e] === M[q][e] ? !0 : !1; else F = !0;
                    if (b && 0 < b.length)for (e = 0; e < b.length; e++)G = s[q - 1][e] === s[q][e] ? !0 : !1; else G = !0;
                    if (c && 0 < c.length)for (e = 0; e < c.length; e++)J = H[q - 1][e] === H[q][e] ? !0 : !1; else J = !0
                }
                if (E && F && G && J)break;
                q++
            }
    ...
    B.prototype.renderStripLinesOfThicknessType = function (a) {
        if (this.stripLines && 0 < this.stripLines.length && a) {
            ...
            for (c = 0; c < this._stripLineLabels.length; c++)if (n = this.stripLines[c], b = this._stripLineLabels[c], !(b.position < this.viewportMinimum || b.position > this.viewportMaximum || isNaN(this.range))) {
                ...
                if ("outside" === b.stripLine.labelPlacement)if (n && (this.ctx.strokeStyle = n.color, "pixel" === n._thicknessType && (this.ctx.lineWidth = n.thickness)), "bottom" === this._position) {
    ...
    A.prototype.getPercentAndTotal = function (a, d) {
        ...
        if (0 <= a.type.indexOf("stacked")) c = 0, b = d.x.getTime ? d.x.getTime() : d.x, b in a.plotUnit.yTotals && (c = a.plotUnit.yTotals[b], f = isNaN(d.y) ? 0 : 0 === c ? 0 : 100 * (d.y / c)); else if ("pie" === a.type || "doughnut" ===
            a.type) {
