...
<html xmlns="http://www.w3.org/1999/xhtml">
    ...
    <body class="codebrowser">
        ...
        <div id="review">
            <div class="filepath">
                FrontBundle/Resources/public/js/ui/jquery.effects.pulsate.min.js            </div>

            <!DOCTYPE html PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN" "http://www.w3.org/TR/REC-html40/loose.dtd">
<html><body><div class="code"><ol class="code"><li id="line_1" class="odd"><span class="lineNumber">&nbsp;1&nbsp;</span>/*<a name="line_1"></a></li>
<li id="line_2" class="even"><span class="lineNumber">&nbsp;2&nbsp;</span>&nbsp;*&nbsp;jQuery&nbsp;UI&nbsp;Effects&nbsp;Pulsate&nbsp;1.8.16<a name="line_2"></a></li>
...
<li id="line_8" class="even"><span class="lineNumber">&nbsp;8&nbsp;</span>&nbsp;*&nbsp;http://docs.jquery.com/UI/Effects/Pulsate<a name="line_8"></a></li>
...
<li id="line_14" class="even"><span class="lineNumber">14&nbsp;</span>a.options.easing,function(){animateTo==0&amp;&amp;b.hide();a.callback&amp;&amp;a.callback.apply(this,arguments)});b.queue("fx",function(){b.dequeue()}).dequeue()})}})(jQuery);<a name="line_14"></a></li></ol></div></body></html>
                    </div>
    </body>
</html>
