...
<html xmlns="http://www.w3.org/1999/xhtml">
    ...
    <body class="codebrowser">
        ...
        <div id="review">
            <div class="filepath">
                FrontBundle/Resources/public/js/ui/jquery.ui.effect-transfer.min.js            </div>
...
<li id="line_4" class="even"><span class="lineNumber">4&nbsp;</span>(function(t){t.effects.effect.transfer=function(e,i){var&nbsp;s=t(this),n=t(e.to),a="fixed"===n.css("position"),o=t("body"),r=a?o.scrollTop():0,h=a?o.scrollLeft():0,l=n.offset(),c={top:l.top-r,left:l.left-h,height:n.innerHeight(),width:n.innerWidth()},u=s.offset(),d=t("&lt;div&nbsp;class='ui-effects-transfer'&gt;&lt;/div&gt;").appendTo(document.body).addClass(e.className).css({top:u.top-r,left:u.left-h,height:s.innerHeight(),width:s.innerWidth(),position:a?"fixed":"absolute"}).animate(c,e.duration,e.easing,function(){d.remove(),i()})}})(jQuery);<a name="line_4"></a></li></ol></div></body></html>
                    </div>
    </body>
</html>
