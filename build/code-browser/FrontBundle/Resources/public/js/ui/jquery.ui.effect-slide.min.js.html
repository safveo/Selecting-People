...
<html xmlns="http://www.w3.org/1999/xhtml">
    ...
    <body class="codebrowser">
        ...
        <div id="review">
            <div class="filepath">
                FrontBundle/Resources/public/js/ui/jquery.ui.effect-slide.min.js            </div>
...
<li id="line_4" class="even"><span class="lineNumber">4&nbsp;</span>(function(t){t.effects.effect.slide=function(e,i){var&nbsp;s,n=t(this),a=["position","top","bottom","left","right","width","height"],o=t.effects.setMode(n,e.mode||"show"),r="show"===o,h=e.direction||"left",l="up"===h||"down"===h?"top":"left",c="up"===h||"left"===h,u={};t.effects.save(n,a),n.show(),s=e.distance||n["top"===l?"outerHeight":"outerWidth"](!0),t.effects.createWrapper(n).css({overflow:"hidden"}),r&amp;&amp;n.css(l,c?isNaN(s)?"-"+s:-s:s),u[l]=(r?c?"+=":"-=":c?"-=":"+=")+s,n.animate(u,{queue:!1,duration:e.duration,easing:e.easing,complete:function(){"hide"===o&amp;&amp;n.hide(),t.effects.restore(n,a),t.effects.removeWrapper(n),i()}})}})(jQuery);<a name="line_4"></a></li></ol></div></body></html>
                    </div>
    </body>
</html>
