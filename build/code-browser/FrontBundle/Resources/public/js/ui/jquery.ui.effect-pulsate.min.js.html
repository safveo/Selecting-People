...
<html xmlns="http://www.w3.org/1999/xhtml">
    ...
    <body class="codebrowser">
        ...
        <div id="review">
            <div class="filepath">
                FrontBundle/Resources/public/js/ui/jquery.ui.effect-pulsate.min.js            </div>
...
<li id="line_4" class="even"><span class="lineNumber">4&nbsp;</span>(function(t){t.effects.effect.pulsate=function(e,i){var&nbsp;s,n=t(this),a=t.effects.setMode(n,e.mode||"show"),o="show"===a,r="hide"===a,h=o||"hide"===a,l=2*(e.times||5)+(h?1:0),c=e.duration/l,u=0,d=n.queue(),p=d.length;for((o||!n.is(":visible"))&amp;&amp;(n.css("opacity",0).show(),u=1),s=1;l&gt;s;s++)n.animate({opacity:u},c,e.easing),u=1-u;n.animate({opacity:u},c,e.easing),n.queue(function(){r&amp;&amp;n.hide(),i()}),p&gt;1&amp;&amp;d.splice.apply(d,[1,0].concat(d.splice(p,l+1))),n.dequeue()}})(jQuery);<a name="line_4"></a></li></ol></div></body></html>
                    </div>
    </body>
</html>
