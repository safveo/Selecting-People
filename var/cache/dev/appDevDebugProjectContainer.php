...
class appDevDebugProjectContainer extends Container
{
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService($lazyLoad = true)
    {
        ...
        $b = new \Doctrine\ORM\Mapping\Driver\AnnotationDriver($a, array(0 => ($this->targetDirs[3].'\\src\\UserBundle\\Entity'), 1 => ($this->targetDirs[3].'\\src\\BackBundle\\Entity')));
        ...
        $d->setEntityNamespaces(array('UserBundle' => 'UserBundle\\Entity', 'BackBundle' => 'BackBundle\\Entity'));
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf2orm_default_42249c9605adc76bdbf366dd1c7e86aabfd20318fa431d129009ad767c746b4c');
    ...
    protected function getSecurity_Firewall_Map_Context_MainService()
    {
        ...
        $o = new \Symfony\Component\Security\Http\Firewall\LogoutListener($b, $n, new \Symfony\Component\Security\Http\Logout\DefaultLogoutSuccessHandler($n, 'fos_user_security_login'), array('csrf_parameter' => '_csrf_token', 'csrf_token_id' => 'logout', 'logout_path' => 'fos_user_security_logout'));
        $o->addHandler($e);

        $p = new \Symfony\Component\Security\Http\Authentication\DefaultAuthenticationSuccessHandler($n, array());
        $p->setOptions(array('always_use_default_target_path' => true, 'default_target_path' => 'ecran_index', 'login_path' => '/login', 'target_path_parameter' => '_target_path', 'use_referer' => false));
